...
namespace Murmur.Transcription;

/// <summary>Reports on and clears everything under %LOCALAPPDATA%/Murmur/models (Whisper ggml files and the Parakeet folder).</summary>
