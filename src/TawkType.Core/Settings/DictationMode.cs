...
public sealed class DictationMode
{
    ...
    /// Additive rather than a replacement: corrections the user has taught TawkType should not stop
...
/// <summary>
/// The four modes TawkType ships with, and the rules for picking between them.
/// </summary>
