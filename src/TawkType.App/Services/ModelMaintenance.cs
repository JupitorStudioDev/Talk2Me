...
public sealed class ModelMaintenance
{
    ...
    /// <summary>
    /// Every model TawkType knows how to fetch, marked with what is already here and what the current
    ...
    /// <summary>
    /// Downloads one model by key. This is the only thing in TawkType that downloads one: the
