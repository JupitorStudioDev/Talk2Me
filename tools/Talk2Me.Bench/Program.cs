...
if (args.Length == 0)
{
    Console.WriteLine("usage: Talk2Me.Bench <audio.wav> [engine=Both|Parakeet|Whisper] [runs=3] [language=en] [whisperModel=LargeV3Turbo]");
    return 1;
}
...
var settings = new StaticSettings(new Talk2MeSettings { Model = whisperModel, Language = language });
...
{
    public StaticSettings(Talk2MeSettings settings) => Current = settings;

    public Talk2MeSettings Current { get; }
