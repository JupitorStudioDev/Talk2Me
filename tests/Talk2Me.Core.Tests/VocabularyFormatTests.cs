...
public class VocabularyFormatTests
{
    ...
    {
        TextReplacement[] replacements = [new("talk to me", "Talk2Me"), new("jupitor", "Jupitor Studio")];
    ...
    {
        var parsed = VocabularyFormat.ParseReplacements("talk to me=>Talk2Me");

        Assert.Equal([new TextReplacement("talk to me", "Talk2Me")], parsed);
    }
    ...
    public void A_vocabulary_file_survives_a_round_trip()
    {
        ...
        {
            Spellings = ["Talk2Me"],
            Replacements = [new TextReplacement("talk to me", "Talk2Me")],
    ...
    public void Half_written_entries_are_dropped_on_import()
    {
        ...
        Assert.NotNull(read);
        Assert.Equal(["Talk2Me"], read!.Spellings);
