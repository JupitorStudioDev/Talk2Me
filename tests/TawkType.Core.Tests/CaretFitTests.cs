...
public class CaretFitTests
{
    ...
    [Fact]
    public void A_capital_tawktype_added_is_undone_mid_sentence()
    ...
    /// <summary>
    /// The whole safety of this rests on only ever undoing a capital TawkType itself added. A name the
