...
public class DictationModeTests
{
    ...
    {
        var main = new VocabularySettings { Spellings = ["TawkType"] };
    ...
    {
        var older = new TawkTypeSettings
        {
            Modes = [],
    ...
    {
        var older = new TawkTypeSettings { Modes = [], AppendTrailingSpace = true, RemoveFillerWords = true };
